...
# 259 "Dual_MUX_4.c"
    var_Buff = PORTA;
    var_Buff = var_Buff & 0b00011000;
    Var_Ch3 = var_Buff >> 3;


    var_Buff = PORTD;
    Var_Ch2 = (var_Buff & 0b00001100) >> 2;
    ...
    var_Buff = (PORTB & 0b00001000) >> 3;

    var_Buff2 = (PORTA & 0b00100000) >> 4;
    Var_Ch0 = var_Buff | var_Buff2;
...
void write_outputs(void) {
    ...
    var_Buff = (Var_Y & 0b00000010) << 6;
    var_Buff2 = (Var_Y & 0b00000001) << 2;
