...
static char var_Timer_out_pre;

static char current_state = 'A';

static char var_CLK_flag;
static char var_Trigger_flag;

static char var_Timer_flag;



static unsigned int var_Counter_mod65536;
static unsigned int var_TC_N1;
...
else if (var_Trigger_flag == 1 && var_RT == 1) {
current_state = 'B';
var_Trigger_flag = 0;
}
else
