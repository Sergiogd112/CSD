...
# 53 "C:/Program Files/Microchip/MPLABX/v6.00/packs/Microchip/PIC18Fxxxx_DFP/1.3.36/xc8\pic\include\proc\pic18f4520.h"
...
# 98
static char var_Timer_out;
static char var_ETP;

static char current_state;

static char var_CLK_flag;
static char var_TRG_flag;

static char var_CD_flag;


static unsigned int var_PC;


static unsigned int var_Counter_mod64k;
static unsigned int var_Max_Count;

static char var_TC_flag;
...
void read_inputs(void)
{
unsigned int var_Buff1 = 0;
unsigned int var_Buff2 = 0;
unsigned int var_Buff3 = 0;
unsigned int var_Buff4 = 0;


var_Buff1 = (PORTA & 0b00001111) << 4;
var_Buff2 = (PORTB & 0b11110000) << 4;

var_Buff3 = (PORTC & 0b11111111);
var_Buff4 = (var_Buff3 & 0x00F0) << 8;

var_Buff3 = (var_Buff3 & 0b0000000000001111);
