...
-- Design Ports Information
-- W	=>  Location: PIN_B2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF Circuit_W IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \W~0_combout\ = ((\B~input_o\ & (\D[1]~input_o\)) # (!\B~input_o\ & ((\D[0]~input_o\)))) # (!\A~input_o\)
