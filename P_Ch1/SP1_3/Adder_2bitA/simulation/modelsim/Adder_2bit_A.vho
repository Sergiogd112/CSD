...
-- Design Ports Information
-- S[0]	=>  Location: PIN_A2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- B[1]	=>  Location: PIN_D9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- A[1]	=>  Location: PIN_D10,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF Adder_2bit_A IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \C~1_combout\ = (\Cin~input_o\ & ((\B[0]~input_o\) # (\A[0]~input_o\)))
...
-- Equation(s):
-- \S~1_combout\ = \B[1]~input_o\ $ (\A[1]~input_o\ $ (((\C~1_combout\) # (\C~0_combout\))))
...
-- Equation(s):
-- \Cout~0_combout\ = (\B[1]~input_o\ & ((\C~1_combout\) # ((\A[1]~input_o\) # (\C~0_combout\)))) # (!\B[1]~input_o\ & (\A[1]~input_o\ & ((\C~1_combout\) # (\C~0_combout\))))
